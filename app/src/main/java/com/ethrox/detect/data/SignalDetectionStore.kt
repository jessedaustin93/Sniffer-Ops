...
import com.ethrox.detect.sync.NodeLocationProvider
...
class SignalDetectionStore(context: Context) {
    ...
    private fun movementSessionId(location: com.ethrox.detect.sync.NodeLocation?, now: Long): String {
    ...
    private fun SignalDevice.mergeWith(
        ...
        now: Long,
        location: com.ethrox.detect.sync.NodeLocation?
    ): SignalDevice = copy(
