...
function Get-SdrSignalExplanation {
    ...
    $rules = @(
        ...
        @{ Min = 148.0; Max = 162.0; Type = "VHF land mobile, business, railroad, marine, or public service"; Mod = "NFM/data"; Confidence = "Medium"; Meaning = "Shared VHF services; exact use depends on the local channel allocation."; Next = "Use narrowband FM and compare exact frequency against local allocation databases." },
        ...
        @{ Min = 162.55; Max = 174.0; Type = "VHF land mobile, business, railroad, marine, or public service"; Mod = "NFM/data"; Confidence = "Medium"; Meaning = "Shared VHF services; exact use depends on the local channel allocation."; Next = "Use narrowband FM and compare exact frequency against local allocation databases." },
