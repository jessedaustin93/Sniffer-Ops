...
SYNC_PATHS = ("/ethrox-detect/sync", "/ethrox-detect/sync")
AWARENESS_PATHS = ("/ethrox-detect/awareness", "/ethrox-detect/awareness")
HEALTH_PATHS = ("/ethrox-detect/health", "/ethrox-detect/health")
